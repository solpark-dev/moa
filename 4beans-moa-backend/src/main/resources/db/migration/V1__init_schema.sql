...
CREATE TABLE PRODUCT (
    ...
    PRICE INT NOT NULL,
    MAX_SHARE INT NULL COMMENT '최대 공유 인원',
    IMAGE VARCHAR(255) NULL,
    CANCEL_URL VARCHAR(500) NULL COMMENT '서비스 공식 해지 페이지 URL',

    PRIMARY KEY (PRODUCT_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='상품 정보 (OTT 구독 서비스)';
...
CREATE TABLE ACCOUNT (
    ...
    FINTECH_USE_NUM VARCHAR(30) NULL COMMENT '핀테크이용번호 (오픈뱅킹 연동용)',
    STATUS VARCHAR(20) NOT NULL DEFAULT 'ACTIVE' COMMENT '계좌 상태 (ACTIVE/INACTIVE/BLOCK)',
    REG_DATE DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    VERIFY_DATE DATETIME NULL,

    PRIMARY KEY (ACCOUNT_ID),
    UNIQUE KEY UQ_ACCOUNT_USER (USER_ID),
    CONSTRAINT CHK_ACCOUNT_STATUS CHECK (STATUS IN ('ACTIVE', 'INACTIVE', 'BLOCK'))
...
CREATE TABLE DEPOSIT (
    ...
    CONSTRAINT CHK_DEPOSIT_STATUS CHECK (DEPOSIT_STATUS IN ('PENDING', 'PAID', 'REFUNDED', 'PARTIAL_REFUNDED', 'FORFEITED'))
...
CREATE TABLE PAYMENT (
    ...
    SETTLEMENT_ID INT NULL COMMENT '정산 ID (FK - SETTLEMENT_DETAIL 대체)',
...
CREATE TABLE SETTLEMENT (
    ...
    CONSTRAINT CHK_SETTLEMENT_STATUS CHECK (SETTLEMENT_STATUS IN ('PENDING', 'PENDING_ACCOUNT', 'IN_PROGRESS', 'COMPLETED', 'FAILED'))
